...
MOD_IDS=$(<$SERVER_DIR/script_server_linux/mod_ids.txt)

IFS=';' read -ra IDS <<< "$MOD_IDS"

WEBHOOK_URL="https://discord.com/api/webhooks/1381722890764030173/nqX-H148ivbuIbY_URkWRLx7oNtzmgSuGppVaGB4FaytVNUHFuVYC3Qdl9f72-pSpVAL"
